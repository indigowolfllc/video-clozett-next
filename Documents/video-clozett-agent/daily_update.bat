@echo off
:: [2602230820] Daily Insight Automation Pipeline (Stable UTF-8)
chcp 65001 > nul
...
git add .
git commit -m "fix: [2602230820] Stable character encoding and metrics update"
